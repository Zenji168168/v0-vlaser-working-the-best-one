  ...
  return (
    <div className="min-h-screen bg-white text-foreground relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-1/2 right-1/4 w-[480px] h-[480px] bg-gradient-to-br from-cyan-400/20 to-blue-400/25 rounded-full blur-[100px] animate-float-blob" style={{ animationDelay: "5s" }} />
        <div className="absolute bottom-1/4 right-1/3 w-[520px] h-[520px] bg-gradient-to-br from-violet-400/25 to-purple-500/20 rounded-full blur-[105px] animate-float-blob-slow" style={{ animationDelay: "10s" }} />
        <div className="absolute top-1/3 left-1/3 w-[450px] h-[450px] bg-gradient-to-br from-blue-300/20 to-indigo-400/20 rounded-full blur-[90px] animate-float-blob-fast" style={{ animationDelay: "15s" }} />
      </div>
