...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="py-32 bg-gradient-to-b from-secondary/30 to-background relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div
          className={`glass-ultra rounded-3xl p-10 md:p-12 shadow-2xl shadow-primary/50 hover:shadow-primary/60 transition-smooth hover:scale-105 ${inView ? "animate-scale-in" : "opacity-0"}`}
          ...
          <div className="space-y-6">
            {[
              ...
              return (
                <div
                  key={i}
                  className="flex gap-4 glass rounded-2xl p-6 hover:glass-strong transition-smooth hover:scale-105"
                >
