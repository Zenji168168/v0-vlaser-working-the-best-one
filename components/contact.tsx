...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-32 bg-gradient-to-b from-blue-50/30 to-white relative overflow-hidden">
      <div className="absolute top-20 right-20 w-80 h-80 bg-purple-300/20 rounded-full blur-3xl animate-float" />
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className={`glass-strong rounded-3xl p-10 md:p-12 shadow-2xl shadow-indigo-200/30 ${inView ? "animate-scale-in" : "opacity-0"}`} style={{ animationDelay: "200ms" }}>
          ...
          <div className="space-y-6">
            {[
              ...
              return (
                <div key={i} className="flex gap-4 glass rounded-2xl p-6 hover:glass-strong transition-smooth">
