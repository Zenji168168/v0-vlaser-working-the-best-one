  ...
  return (
    <section id="hero" className="relative overflow-hidden min-h-screen flex items-center justify-center">
      <div className="absolute inset-0 bg-gradient-to-br from-background via-secondary to-muted/50">
        <div className="absolute top-10 right-10 w-[300px] sm:w-[400px] md:w-[500px] h-[300px] sm:h-[400px] md:h-[500px] bg-gradient-to-br from-burgundy/30 to-gold/25 blur-[80px] md:blur-[100px] animate-float-blob animate-morph-shape" />
        <div className="absolute bottom-10 left-10 w-[280px] sm:w-[380px] md:w-[450px] h-[280px] sm:h-[380px] md:h-[450px] bg-gradient-to-br from-gold/30 to-burgundy/25 blur-[70px] md:blur-[90px] animate-float-blob-slow animate-morph-shape" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] sm:w-[450px] md:w-[550px] h-[320px] sm:h-[450px] md:h-[550px] bg-gradient-to-br from-burgundy/25 to-gold/20 blur-[85px] md:blur-[110px] animate-float-blob-fast animate-morph-shape" />
        <div
          className="hidden md:block absolute top-1/4 right-1/3 w-[400px] h-[400px] bg-gradient-to-br from-gold/20 to-turquoise/20 blur-[80px] animate-float-blob animate-morph-shape"
          style={{ animationDelay: "8s" }}
        />
        <div
          className="hidden lg:block absolute bottom-1/3 left-1/4 w-[480px] h-[480px] bg-gradient-to-br from-turquoise/25 to-gold/20 blur-[95px] animate-float-blob-slow animate-morph-shape"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 py-12 sm:py-16 lg:py-20">
        ...
        >
          <div className="mb-4 sm:mb-6 md:mb-8 inline-flex items-center gap-2 glass-strong px-4 sm:px-6 py-2 sm:py-3 rounded-full animate-bounce-in-scale">
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-burgundy animate-pulse" />
            <span className="text-xs sm:text-sm font-semibold text-burgundy">{t("hero.founded")}</span>
          </div>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 lg:gap-8 max-w-2xl mx-auto">
            <div className="glass px-2 sm:px-4 md:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl md:rounded-2xl animate-slide-in-left">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-burgundy">5+</div>
            ...
            <div className="glass px-2 sm:px-4 md:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl md:rounded-2xl animate-zoom-in-rotate">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-gold">100+</div>
              <div className="text-[10px] sm:text-xs md:text-sm text-muted-foreground leading-tight">
                {t("hero.stat2")}
              </div>
            </div>
            <div className="glass px-2 sm:px-4 md:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl md:rounded-2xl animate-slide-in-right">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-turquoise">24/7</div>
              <div className="text-[10px] sm:text-xs md:text-sm text-muted-foreground leading-tight">
                {t("hero.stat3")}
              </div>
            </div>
        ...
        <div className="hidden sm:block absolute bottom-4 sm:bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="glass w-7 h-11 sm:w-8 sm:h-12 md:w-10 md:h-14 rounded-full flex items-start justify-center p-2 border-2 border-primary/50">
            <div className="w-1 h-2 sm:w-1.5 sm:h-3 md:w-2 md:h-4 bg-gradient-to-b from-burgundy to-gold rounded-full animate-pulse" />
          </div>
        </div>
      </div>
    </section>
